...
# ── Shopee TW（台湾）カテゴリ辞書 ──────────────────────────────────
# Shopee TW カテゴリ ID は shopee.tw の公式カテゴリに準拠
SHOPEE_TW_CATEGORIES: Dict[str, int] = {
    # 電子 3C
    "3C > 耳機/音響":             11000023,
    "3C > 手機/平板":             11000024,
    "3C > 電腦/周邊":             11000025,
...
# 内部カテゴリ → Shopee TW カテゴリ ID マッピング
TW_CATEGORY_DEFAULT_MAP: Dict[str, int] = {
    "electronics": 11000023,
    "clothing":    11000031,
    "accessories": 11000035,
    "toys":        11000080,
    "food":        11000060,
    "cosmetics":   11000040,
    "health":      11000062,
